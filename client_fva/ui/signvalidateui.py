...
"background-color:rgb(216, 230, 225);")
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 577, 297))
...
"background-color: rgb(229, 229, 229);")
        ...
        self.gridLayout.addWidget(self.validate, 13, 0, 1, 1)
...
"color: rgb(0, 0, 0);")
        ...
        self.gridLayout.addWidget(self.lugar, 8, 2, 1, 1)
...
"background-color: rgb(229, 229, 229);")
        ...
        self.gridLayout.addWidget(self.sign, 13, 2, 1, 1)
...
"color: rgb(0, 0, 0);")
        ...
        self.gridLayout.addWidget(self.label_lugar, 7, 2, 1, 1)
...
"color: rgb(0, 0, 0);")
        ...
        self.gridLayout.addWidget(self.label_razon, 7, 0, 1, 1)
        self.razon = QtWidgets.QLineEdit(self.fileFrame)
        self.razon.setObjectName("razon")
        self.gridLayout.addWidget(self.razon, 8, 0, 1, 1)
...
"background-color: rgb(229, 229, 229);")
        ...
        self.browseFiles.setIcon(icon3)
        self.browseFiles.setObjectName("browseFiles")
        self.gridLayout.addWidget(self.browseFiles, 4, 0, 1, 1)
        ...
        self.filesWidget.setHorizontalScrollBarPolicy(QtCore.Qt.ScrollBarAlwaysOff)
