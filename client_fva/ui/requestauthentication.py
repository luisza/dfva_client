...
class RequestAuthentication(Ui_RequestAuthentication):
    ...
    def __init__(self, widget, main_app, db, index):
        ...
        self.contacts_model = ContactModel(user=index, db=db)
        ...
        self.auth_list = []
        self.requestAuthentication.click()
    ...
    def add_contact(self):
        ...
        if id:
            ...
            QtWidgets.QMessageBox.warning(self.widget, 'Contacto no identificado',
                 "Lo ingresado no es un numbre de contacto o un número de identificación válido.")
