...
class TabManager(QObject):
    ...
    def create_list_menu(self, fvaspeaker, name):
        ...
        if certs:
            ...
            self.card_information.setItem(self.card_count,2, QTableWidgetItem(cert['cert_start'].strftime("%Y-%m-%d %H:%M")))  
            self.card_information.setItem(self.card_count,3, QTableWidgetItem(cert['cert_expire'].strftime("%Y-%m-%d %H:%M"))) 
