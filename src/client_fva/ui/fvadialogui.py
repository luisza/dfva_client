...
# Form implementation generated from reading ui file 'client_fva/ui/ui_elements/fvadialog.ui'
#
...
class Ui_FVADialog(object):
    def setupUi(self, FVADialog):
        ...
        self.formLayoutWidget.setGeometry(QtCore.QRect(250, 90, 261, 103))
        ...
        self.displaytimeout.setStyleSheet("color:rgb(164, 0, 0)")
        ...
        self.requesting.setGeometry(QtCore.QRect(10, 220, 501, 31))
        self.requesting.setText("")
        self.requesting.setObjectName("requesting")
        self.information = QtWidgets.QLabel(FVADialog)
        self.information.setGeometry(QtCore.QRect(20, 10, 491, 61))
        ...
        self.image.setGeometry(QtCore.QRect(20, 70, 211, 141))
        self.image.setText("")
