...
"background-color:rgb(216, 230, 225);")
        ...
        self.bodyLayout.addWidget(self.usrSlots)
...
"background-color:rgb(216, 230, 225);}")
        ...
        self.statusBar = QtWidgets.QStatusBar(FVAClientUI)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Maximum, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.statusBar.sizePolicy().hasHeightForWidth())
        self.statusBar.setSizePolicy(sizePolicy)
        self.statusBar.setMinimumSize(QtCore.QSize(660, 0))
        self.statusBar.setObjectName("statusBar")
        FVAClientUI.setStatusBar(self.statusBar)
